...
function menu() {
    ...
    if (menuBtn.style.transform == "rotate(90deg)") { // when closing menu / push the menu button
    ...
    } else { // when opening menu / push the menu button
...
function checkIfIWin(mat) {
    ...
    if (rowsCheckRes == true && columsCheckRes == true && boxCheckRes == true) { //if you win
